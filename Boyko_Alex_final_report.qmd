...
## Data Overview
The data for this project comes from `nflverse`, an R package built around play-by-play data. Data from 2022 was used to perform an exploratory data analysis on the set of variables and make decisions about which may have the greatest impact of predicting play calls.
...
These models were asked to create predictions across the entire league, encompassing all of the possible variation. For example, look at the following graph.
